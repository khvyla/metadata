...
export { createRecognitionIndex, FIXED_RECOGNITION_CONFIGURATION, RECOGNITION_INDEX_SCHEMA_VERSION } from "./recognition-index";
...
export type { RecognitionIndex, RecognitionIndexOpenError, RecognitionIndexRecording, RecognitionIndexResult, RecognitionIndexSegment, RecognitionIndexStats } from "./recognition-index";
